 ...
 * 
 * Esta funci�n abre un archivo binario en modo append y escribe
 * el dato proporcionado al final del archivo. Si el archivo no
 * existe, se crea autom�ticamente.
 *
...
/**
 * @brief Elimina un registro espec�fico de un archivo binario.
 *
 * Esta funci�n plantilla permite eliminar un elemento de tipo T almacenado en un
 ...
 *          obligatoriamente un atributo p�blico llamado `id`.
 *
 * @param fileName Nombre del archivo binario en el cual se realizar� la operaci�n.
 * @param dato Registro que contiene el `id` del elemento que se busca eliminar.
 *
 * @return true Si el archivo se abri� correctamente y la operaci�n se ejecut�.
 * @return false Si el archivo no pudo abrirse o si ocurri� un error.
 */
